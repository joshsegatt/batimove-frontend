...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu - SIMPLIFIED WITH DEBUG */}
      {isMobileMenuOpen && (() => {
        ...
        return (
          <>
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center items-center gap-8" style={{ backgroundColor: '#f0f0f0', padding: '20px' }}>
                <h1 style={{ color: 'red', fontSize: '24px', fontWeight: 'bold' }}>TESTE MENU</h1>
                {navLinks.map((link) => {
                  console.log('Renderizando link:', link.name);
                  return (
                    <Link
                      key={link.name}
                      to={link.path}
