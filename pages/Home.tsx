           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              <div className="relative h-[600px] hidden lg:flex items-center justify-center perspective-[2000px]">
                 ...
                 <motion.div 
                    ...
                    className="relative w-[540px] aspect-video bg-slate-900 rounded-[2rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.7)] z-10 overflow-hidden group transform-gpu"
                 >
                    {/* Video Element - Added 'will-change-transform' to stabilize scaling */}
                    {/* Updated Video: Professional movers carrying boxes */}
                    <video 
                      autoPlay 
                      muted 
                      loop 
                    ...
                    >
                      <source src="https://videos.pexels.com/video-files/4492121/4492121-hd_1920_1080_25fps.mp4" type="video/mp4" />
