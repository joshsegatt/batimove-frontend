...
const plans = [
  {
    ...
    price: "Dès CHF 900",
    description: "Vous emballez, nous transportons. Idéal pour les petits volumes ou les étudiants organisés.",
    features: [
  ...
  },
  {
    ...
    price: "Dès CHF 1'800",
    description: "Le juste équilibre. Nous gérons le fragile et le démontage, vous gérez le non-fragile.",
    features: [
      "Emballage vaisselle & art",
      "Démontage & Remontage",
      "Penderies portables",
      "Assurance 'All Risk'"
    ],
  ...
  },
  {
    ...
    tagline: "Expérience VIP",
    // 3D Crown
    image: "https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Crown.png",
    price: "Dès CHF 3'200",
    description: "Ne levez pas le petit doigt. Emballage intégral, déballage et nettoyage de fin de bail inclus.",
    features: [
           ...
           <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 overflow-y-auto md:overflow-visible px-2 md:px-0 py-4 snap-x snap-mandatory scrollbar-hide h-full md:h-auto items-stretch">
              ...
              {plans.map((plan, index) => (
                <motion.div
                  ...
                  className={`relative flex flex-col group rounded-[2rem] border transition-all duration-500 snap-center min-w-[280px] md:min-w-0 ${
                    plan.highlight 
                  ...
                  <div className="p-6 lg:p-8 flex flex-col h-full backdrop-blur-md rounded-[2rem]">
                    ...
                    <div className="mt-auto">
                        {plan.action === 'modal' ? (
                            ...
                            <Link to="/quote">
                                <Button 
                                    className={`w-full rounded-xl py-4 text-sm font-bold uppercase tracking-widest transition-all font-display ${
                                    plan.highlight 
