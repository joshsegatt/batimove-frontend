...
const businessPillars = [
  ...
  {
    id: 'hr',
    title: "Mobilité Collaborateurs",
    subtitle: "Expérience RH Premium",
    // 3D Briefcase (Stable replacement for Handshake)
    icon3d: "https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Briefcase.png",
    description: "Soulagez vos RH. Nous gérons la relocation complète de vos employés (Visa, Logement, Écoles) pour une intégration en douceur en Suisse ou à l'international.",
    stats: "Conciergerie Incluse",
    image: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=2664&auto=format&fit=crop" // Professional meeting
  }
];
          ...
          <div className="space-y-3">
             {businessPillars.map((pillar, idx) => (
               <button
                 ...
                 className={`w-full text-left p-4 rounded-2xl transition-all duration-200 group flex items-center justify-between border backdrop-blur-sm ${
                   activeTab === idx 
               ...
               >
                 <div className="flex items-center gap-4">
                    ...
                    <div className={`w-12 h-12 flex-shrink-0 flex items-center justify-center transition-transform duration-200 ${
                       activeTab === idx ? 'scale-110' : 'scale-100 opacity-80 group-hover:opacity-100 group-hover:scale-105'
                    }`}>
                      <img 
                         src={pillar.icon3d} 
                         alt={pillar.title}
                 ...
                 <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div className="flex gap-4 mt-8">
                        {['Audit Gratuit', 'Chef de Projet Dédié', 'Assurance Ad Valorem'].map((tag, i) => (
