...
const servicesList = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1527513230962-9e51ba5b72cd?q=80&w=2070&auto=format&fit=crop",
    isPopular: false
  },
  {
    id: 'storage',
             ...
             <div className="relative z-10">
               ...
               <div className="flex flex-col sm:flex-row justify-center gap-5 items-center">
                 ...
                 <a href="tel:+41225550000" className="w-full sm:w-auto group">
                   <Button 
                    size="lg" 
                    className="w-full sm:w-auto rounded-full px-10 py-4 bg-white text-batimove-blue hover:bg-slate-50 shadow-xl shadow-white/10 border-none font-bold flex items-center justify-center gap-2 font-display transition-all hover:-translate-y-1"
                   >
